...
//#include "com_im_openpush_fork_NativeRuntime.h"
 ...
 * 返回ABI给Java
 */
jstring Java_com_im_openpush_fork_NativeRuntime_stringFromJNI(JNIEnv* env, jobject thiz) {
#if defined(__arm__)
 ...
 * 查找进程
 */
pid_t JNICALL Java_com_im_openpush_fork_NativeRuntime_findProcess(JNIEnv* env,
                                                          jobject thiz, jstring cchrptr_ProcessName) {
    char * rtn = jstringTostring(env, cchrptr_ProcessName);
    LOGI("Java_com_im_openpush_fork_NativeRuntime_findProcess run....ProcessName:%s", rtn);
    //return 1;
 ...
 * 启动Service
 */
void Java_com_im_openpush_fork_NativeRuntime_startService(JNIEnv* env, jobject thiz,
    ...
    LOGI("Java_com_im_openpush_fork_NativeRuntime_startService run....ProcessName:%s", rtn);
    a = rtn;
    start(1, rtn, sd);
}
 ...
 * 启动Activity
 */
void Java_com_im_openpush_fork_NativeRuntime_startActivity(JNIEnv* env, jobject thiz,
